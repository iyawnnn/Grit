...
<x-modal name="create-cover-letter-modal" maxWidth="md" align="center">
    <div class="relative bg-white rounded-2xl mx-auto w-full">
        <div class="bg-gradient-to-b from-[#fff5f0] to-white px-6 py-8 border-b border-gray-100 text-center rounded-t-2xl">
        ...
        <div class="p-6" x-data="{ open: false, selectedId: @entangle('selectedJobForNewLetter') }">
            <div class="mb-8">
                <label class="block text-sm font-bold text-gray-700 mb-2">Target Application</label>

                <div class="relative w-full">
                    <button x-ref="targetSelect" type="button" @click="open = !open" @click.outside="open = false"
                    ...
                    <template x-teleport="body">
                        <div x-show="open" x-cloak x-transition.opacity
                            x-anchor.bottom-start.offset.4="$refs.targetSelect"
                            class="absolute {{ env('VITE_PORTAL_Z_INDEX_CLASS', 'z-[9999]') }} min-w-[300px] w-full max-w-md rounded-xl bg-white shadow-xl border border-gray-100 overflow-hidden py-2 max-h-60 overflow-y-auto custom-scrollbar">
