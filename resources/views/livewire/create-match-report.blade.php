<div class="bg-white rounded-b-2xl overflow-hidden">
    <form wire:submit="generate" class="p-6 sm:p-8 flex flex-col gap-8">
        ...
        <div class="pt-6 border-t border-gray-100 flex justify-end shrink-0">
            <button type="submit" wire:loading.attr="disabled"
                class="w-full md:w-auto px-8 py-3.5 bg-[#e26a35] text-white rounded-xl text-sm font-bold tracking-tight hover:bg-[#cf5b29] transition-all duration-200 shadow-sm flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
