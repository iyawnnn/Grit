<x-app-layout>
    <x-slot:title>Add Job Posting</x-slot:title>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6 mb-10">
            <div class="flex flex-col items-center md:items-start w-full md:w-auto">
                <div class="flex items-center justify-center md:justify-start gap-3 mb-2">
                    ...
                    <h1 class="text-3xl font-extrabold tracking-tight text-gray-900">Add Job Posting</h1>
                </div>
                <p class="text-base font-medium text-gray-500 max-w-sm mx-auto md:mx-0">Save a new job to your career pipeline tracking list.</p>
            </div>
    ...
    <style>
        ...
        trix-toolbar {
            background-color: #f9fafb; /* Light gray toolbar */
        ...
        trix-editor {
            background-color: #ffffff; /* Crisp white typing area */
            min-height: 350px;
            padding: 1.5rem;
            font-size: 0.875rem;
            line-height: 1.5;
