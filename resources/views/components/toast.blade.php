...
<div x-data="{ 
    ...
    " @notify.window="
        // Livewire 3 sends objects in an array, Alpine sends direct objects. This handles both.
    ...
    <div x-show="!isError" class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-[#e26a35] bg-[#fff5f0] border border-[#e26a35]/20 rounded-lg">
    ...
    <div x-show="isError" class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-red-600 bg-red-50 border border-red-100 rounded-lg">
        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
